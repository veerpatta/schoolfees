...
import type { PaymentDeskMobileProps } from "@/modules/payments/ui/payment-desk-mobile";
...
const PaymentDeskClient = dynamic(
  () => import("@/modules/payments/ui/payment-desk-mobile").then((mod) => mod.PaymentDeskClient),
  {
    ssr: false,
