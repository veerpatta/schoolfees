...
import { isPendingAdmissionNo, STUDENT_PAGE_SIZE } from "@/modules/students/domain/constants";
...
const BulkStudentEditBar = dynamic(
  () => import("@/modules/students/ui/bulk-student-edit-bar").then((mod) => mod.BulkStudentEditBar),
  { ssr: false },
);
