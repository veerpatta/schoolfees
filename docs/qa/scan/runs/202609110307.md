...
| Run id | `202609110307` |
| Layers | static |
| Git | `9036885d3c60` on main (dirty) |
| Node | v24.19.0 |
| Files read | 1597 |
| Started | 2026-09-11T03:07:30.454Z |
| Duration | 14921 ms |
| Strict gate | no |
...
10 check(s) swept 15046 of 15046 enumerated members.
...
| `sql-safety` | supabase migrations, plus the source files that build SQL text | 1434 | 1434 | exhaustive |
| `i18n` | locale catalogue keys (union x locale) and t() call sites in product source | 7713 | 7713 | exhaustive |
| `dead-code` | export declarations in app/, components/, lib/, hooks/ and i18n/ | 2490 | 2490 | exhaustive |
