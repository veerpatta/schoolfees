...
| Run id | `202609152152` |
| Layers | static |
| Git | `29fd30e0ba53` on school-one/phase-0 (dirty) |
| Node | v24.19.0 |
| Files read | 1672 |
| Started | 2026-09-15T21:52:48.705Z |
| Duration | 14273 ms |
| Strict gate | no |
...
10 check(s) swept 15151 of 15151 enumerated members.

| Check | Dimension | Domain | Examined | Strategy |
|---|---|---:|---:|---|
| `guards` | app route handlers, pages and server-action modules | 128 | 128 | exhaustive |
| `client-boundary` | source modules crossed against the client bundle import graph | 786 | 786 | exhaustive |
| `session-safety` | product source modules scanned for hardcoded academic-session labels | 786 | 786 | exhaustive |
| `money` | product source files (app, components, lib, workers, hooks, i18n; no tests, no scripts) | 786 | 786 | exhaustive |
| `async-safety` | product .ts/.tsx modules parsed by the TypeScript checker | 754 | 754 | exhaustive |
| `mirror-drift` | declared TS/SQL mirror sides, plus migrations added since the last reconcile | 241 | 241 | targeted |
| `sql-safety` | supabase migrations, plus the source files that build SQL text | 1479 | 1479 | exhaustive |
| `i18n` | locale catalogue keys (union x locale) and t() call sites in product source | 7616 | 7616 | exhaustive |
| `dead-code` | export declarations in app/, components/, lib/, hooks/ and i18n/ | 2564 | 2564 | exhaustive |
