...
| Run id | `202608211650` |
| Layers | static |
| Git | `692672493315` on main (dirty) |
| Node | v24.19.0 |
| Files read | 1511 |
| Started | 2026-08-21T16:50:12.642Z |
| Duration | 5289 ms |
| Strict gate | no |
...
10 check(s) swept 14391 of 14391 enumerated members.

| Check | Dimension | Domain | Examined | Strategy |
|---|---|---:|---:|---|
| `guards` | app route handlers, pages and server-action modules | 111 | 111 | exhaustive |
| `client-boundary` | source modules crossed against the client bundle import graph | 715 | 715 | exhaustive |
| `session-safety` | product source modules scanned for hardcoded academic-session labels | 715 | 715 | exhaustive |
| `money` | product source files (app, components, lib, workers, hooks, i18n; no tests, no scripts) | 715 | 715 | exhaustive |
...
| `sql-safety` | supabase migrations, plus the source files that build SQL text | 1340 | 1340 | exhaustive |
| `i18n` | locale catalogue keys (union x locale) and t() call sites in product source | 7699 | 7699 | exhaustive |
| `dead-code` | export declarations in app/, components/, lib/, hooks/ and i18n/ | 2188 | 2188 | exhaustive |
