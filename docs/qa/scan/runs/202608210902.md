...
| Run id | `202608210902` |
| Layers | static |
| Git | `6f6326d410cb` on restructure/feature-first (dirty) |
| Node | v24.19.0 |
| Files read | 1457 |
| Started | 2026-08-21T09:02:50.297Z |
| Duration | 8977 ms |
| Strict gate | no |
...
### P2-001 app/protected/dashboard/page.tsx:538 formats a rupee figure without lib/helpers/currency.ts
...
### P2-002 app/protected/dashboard/page.tsx:540 formats a rupee figure without lib/helpers/currency.ts
...
### P2-003 app/protected/dashboard/page.tsx:541 formats a rupee figure without lib/helpers/currency.ts
...
### P2-004 app/protected/settings/page.tsx:160 formats a rupee figure without lib/helpers/currency.ts
...
### P2-005 app/protected/students/[studentId]/edit/page.tsx:198 formats a rupee figure without lib/helpers/currency.ts
...
### P2-006 app/protected/students/repayment-plan-actions.ts:327 formats a rupee figure without lib/helpers/currency.ts
...
### P2-007 components/students/student-form.tsx:597 formats a rupee figure without lib/helpers/currency.ts
...
### P2-008 components/students/student-form.tsx:600 formats a rupee figure without lib/helpers/currency.ts
...
### P2-009 lib/config/fee-rules.ts:180 formats a rupee figure without lib/helpers/currency.ts

```
id:         893eeec03a40
rule:       scan.money-format-raw  [deterministic]  layer: static
surface:    lib/config/fee-rules.ts:180
expected:   Every rupee a person reads is produced by formatInr() or <Money />, and every other en-IN grouped number by the plain formatter beside it, so a find-references on lib/helpers/currency.ts reaches every one of them.
actual:     This line uses a hand-written "Rs" literal with no period directly. scripts/audit-money-formatting.mjs matches only "Rs." with the period (/["'`]Rs\.\s*\d|>\s*Rs\.\s/), so this spelling passes CI today.
...
### P2-010 lib/dashboard/summary.ts:171 formats a rupee figure without lib/helpers/currency.ts
...
### P2-011 lib/fees/policy.ts:290 formats a rupee figure without lib/helpers/currency.ts
...
### P2-012 lib/fees/workbook-setup-change.ts:125 formats a rupee figure without lib/helpers/currency.ts
...
### P2-013 lib/fees/workbook-setup-change.ts:161 formats a rupee figure without lib/helpers/currency.ts
...
### P2-014 lib/fees/workbook-setup-change.ts:404 formats a rupee figure without lib/helpers/currency.ts
...
### P2-015 lib/fees/workbook-setup-change.ts:418 formats a rupee figure without lib/helpers/currency.ts
...
### P2-016 lib/import/parser.ts:133 formats an en-IN number without lib/helpers/currency.ts
...
### P2-017 lib/import/parser.ts:145 formats an en-IN number without lib/helpers/currency.ts
...
### P2-018 lib/payments/bulk/template.ts:138 formats a rupee figure without lib/helpers/currency.ts
...
### P2-019 lib/payments/data.ts:239 formats a rupee figure without lib/helpers/currency.ts
...
### P2-020 lib/payments/payment-desk-workflow.ts:100 formats a rupee figure without lib/helpers/currency.ts
...
### P2-021 lib/pdf/document-kit.tsx:52 formats a rupee figure without lib/helpers/currency.ts
...
### P2-022 lib/promotion/data.ts:834 formats a rupee figure without lib/helpers/currency.ts
...
### P2-023 lib/promotion/data.ts:975 formats a rupee figure without lib/helpers/currency.ts
...
### P2-024 lib/repayment-plans/schedule.ts:154 formats a rupee figure without lib/helpers/currency.ts
...
### P2-025 lib/setup/data.ts:191 formats a rupee figure without lib/helpers/currency.ts

```
id:         66f85c666492
rule:       scan.money-format-raw  [deterministic]  layer: static
surface:    lib/setup/data.ts:191
expected:   Every rupee a person reads is produced by formatInr() or <Money />, and every other en-IN grouped number by the plain formatter beside it, so a find-references on lib/helpers/currency.ts reaches every one of them.
actual:     This line uses a hand-written "Rs" literal with no period directly. scripts/audit-money-formatting.mjs matches only "Rs." with the period (/["'`]Rs\.\s*\d|>\s*Rs\.\s/), so this spelling passes CI today.
...
### P2-026 No security response header is configured for any document response
...
### P2-027 xlsx is installed from a URL, so npm audit cannot see it
...
### P2-028 app/protected/students/close-due-actions.ts:47 rounds `value` where the domain core truncates it
...
### P2-029 lib/helpers/amount-in-words-hi.ts:73 rounds `value` where the domain core truncates it
...
### P2-030 lib/helpers/amount-in-words.ts:84 rounds `value` where the domain core truncates it
...
### P2-031 lib/pdf/document-kit.tsx:51 rounds `value` where the domain core truncates it
...
### P3-042 app/protected/admin-tools/session-health/session-health-grid.tsx hardcodes the live session 2026-27
...
### P3-043 app/protected/exports/page.tsx declares revalidate = 60, which never takes effect
...
### P3-044 app/protected/fee-setup/page.tsx declares revalidate = 60, which never takes effect
...
### P3-045 app/protected/students/[studentId]/page.tsx hardcodes the live session 2026-27
...
### P3-046 app/protected/students/[studentId]/page.tsx hardcodes the live session 2026-27
...
### P3-047 lib/session/available-sessions.ts hardcodes the live session 2026-27
...
### P3-048 lib/session/available-sessions.ts hardcodes the live session 2026-27
...
| Rule | Severity | Count |
|---|---|---:|
| `scan.money-format-raw` | P2 | 25 / 32 |
