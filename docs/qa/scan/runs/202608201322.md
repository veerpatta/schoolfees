...
| Run id | `202608201322` |
| Layers | static |
| Git | `b88a2248f7ec` on main (dirty) |
| Node | v24.19.0 |
| Files read | 1495 |
| Started | 2026-08-20T13:22:13.955Z |
| Duration | 9221 ms |
| Strict gate | no |
...
11 check(s) swept 14427 of 14427 enumerated members.
...
| `mirror-drift` | declared TS/SQL mirror sides, plus migrations added since the last reconcile | 212 | 212 | targeted |
| `sql-safety` | supabase migrations, plus the source files that build SQL text | 1343 | 1343 | exhaustive |
