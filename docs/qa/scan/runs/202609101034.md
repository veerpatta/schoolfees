...
| Run id | `202609101034` |
| Layers | static |
| Git | `be67bbcde399` on main (dirty) |
| Node | v24.19.0 |
| Files read | 1588 |
| Started | 2026-09-10T10:34:27.944Z |
| Duration | 15728 ms |
| Strict gate | no |
...
10 check(s) swept 15037 of 15037 enumerated members.
...
| `dead-code` | export declarations in app/, components/, lib/, hooks/ and i18n/ | 2483 | 2483 | exhaustive |
