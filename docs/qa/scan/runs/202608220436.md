# Source scan 202608220436

**PASS** · 51 finding(s) · P0 0 · P1 0 · P2 40 · P3 11
...
| Run id | `202608220436` |
| Layers | static |
| Git | `30a60f800bee` on whatsapp-v2-reminders-section (dirty) |
| Node | v24.19.0 |
| Files read | 1521 |
| Started | 2026-08-22T04:36:31.130Z |
| Duration | 5660 ms |
| Strict gate | no |
...
10 check(s) swept 14437 of 14437 enumerated members.

| Check | Dimension | Domain | Examined | Strategy |
|---|---|---:|---:|---|
| `guards` | app route handlers, pages and server-action modules | 112 | 112 | exhaustive |
| `client-boundary` | source modules crossed against the client bundle import graph | 719 | 719 | exhaustive |
| `session-safety` | product source modules scanned for hardcoded academic-session labels | 719 | 719 | exhaustive |
| `money` | product source files (app, components, lib, workers, hooks, i18n; no tests, no scripts) | 719 | 719 | exhaustive |
| `async-safety` | product .ts/.tsx modules parsed by the TypeScript checker | 685 | 685 | exhaustive |
| `mirror-drift` | declared TS/SQL mirror sides, plus migrations added since the last reconcile | 216 | 216 | targeted |
| `sql-safety` | supabase migrations, plus the source files that build SQL text | 1348 | 1348 | exhaustive |
| `i18n` | locale catalogue keys (union x locale) and t() call sites in product source | 7708 | 7708 | exhaustive |
| `dead-code` | export declarations in app/, components/, lib/, hooks/ and i18n/ | 2200 | 2200 | exhaustive |
...
### P2-002 src/app/protected/dashboard/page.tsx:538 formats a rupee figure without lib/helpers/currency.ts
...
### P2-003 src/app/protected/dashboard/page.tsx:540 formats a rupee figure without lib/helpers/currency.ts
...
### P2-004 src/app/protected/dashboard/page.tsx:541 formats a rupee figure without lib/helpers/currency.ts
...
### P2-005 src/app/protected/settings/page.tsx:160 formats a rupee figure without lib/helpers/currency.ts
...
### P2-006 src/app/protected/students/[studentId]/edit/page.tsx:198 formats a rupee figure without lib/helpers/currency.ts
...
### P2-007 src/app/protected/students/repayment-plan-actions.ts:327 formats a rupee figure without lib/helpers/currency.ts
...
### P2-008 src/modules/dashboard/domain/summary.ts:171 formats a rupee figure without lib/helpers/currency.ts
...
### P2-009 src/modules/fees/data/setup-queries.ts:191 formats a rupee figure without lib/helpers/currency.ts
...
### P2-010 src/modules/fees/data/workbook-setup-change.ts:125 formats a rupee figure without lib/helpers/currency.ts
...
### P2-011 src/modules/fees/data/workbook-setup-change.ts:161 formats a rupee figure without lib/helpers/currency.ts
...
### P2-012 src/modules/fees/data/workbook-setup-change.ts:404 formats a rupee figure without lib/helpers/currency.ts
...
### P2-013 src/modules/fees/data/workbook-setup-change.ts:418 formats a rupee figure without lib/helpers/currency.ts
...
### P2-014 src/modules/fees/domain/policy-shaping.ts:154 formats a rupee figure without lib/helpers/currency.ts
...
### P2-015 src/modules/imports/domain/parser.ts:133 formats an en-IN number without lib/helpers/currency.ts
...
### P2-016 src/modules/imports/domain/parser.ts:145 formats an en-IN number without lib/helpers/currency.ts
...
### P2-017 src/modules/payments/data/queries.ts:239 formats a rupee figure without lib/helpers/currency.ts
...
### P2-018 src/modules/payments/domain/bulk/template.ts:138 formats a rupee figure without lib/helpers/currency.ts
...
### P2-019 src/modules/payments/domain/payment-desk-workflow.ts:100 formats a rupee figure without lib/helpers/currency.ts
...
### P2-020 src/modules/promotion/data/queries.ts:834 formats a rupee figure without lib/helpers/currency.ts
...
### P2-021 src/modules/promotion/data/queries.ts:975 formats a rupee figure without lib/helpers/currency.ts
...
### P2-022 src/modules/repayment-plans/domain/schedule.ts:154 formats a rupee figure without lib/helpers/currency.ts
...
### P2-023 src/modules/students/ui/student-form.tsx:597 formats a rupee figure without lib/helpers/currency.ts
...
### P2-024 src/modules/students/ui/student-form.tsx:600 formats a rupee figure without lib/helpers/currency.ts
...
### P2-025 src/platform/config/fee-rules.ts:180 formats a rupee figure without lib/helpers/currency.ts
...
### P2-026 src/platform/pdf/document-kit.tsx:52 formats a rupee figure without lib/helpers/currency.ts
...
### P2-027 src/app/protected/students/close-due-actions.ts:47 rounds `value` where the domain core truncates it
...
### P2-028 src/platform/helpers/amount-in-words-hi.ts:73 rounds `value` where the domain core truncates it
...
### P2-029 src/platform/helpers/amount-in-words.ts:84 rounds `value` where the domain core truncates it
...
### P2-030 src/platform/pdf/document-kit.tsx:51 rounds `value` where the domain core truncates it
...
### P2-031 private.enforce_max_active_conventional_discounts is defined without a pinned search_path
...
### P2-032 private.prevent_receipt_adjustment_mutation is defined without a pinned search_path
...
### P2-033 private.enforce_max_active_conventional_discounts_in_schema is defined without a pinned search_path
...
### P2-034 private.enforce_third_child_traceability is defined without a pinned search_path
...
### P2-035 private.derive_family_child_client_request_id is defined without a pinned search_path
...
### P2-036 public.refresh_financial_materialized_views is defined without a pinned search_path
...
### P2-037 private.prevent_notion_sync_log_mutation is defined without a pinned search_path
...
### P2-038 public.v_notion_student_fee_summary does not set security_invoker
...
### P2-039 public.v_notion_daily_collection_summary does not set security_invoker
...
### P2-040 public.v_notion_family_fee_summary does not set security_invoker
...
### P3-041 src/app/protected/admin-tools/session-health/session-health-grid.tsx hardcodes the live session 2026-27
...
### P3-042 src/app/protected/exports/page.tsx declares revalidate = 60, which never takes effect
...
### P3-043 src/app/protected/fee-setup/page.tsx declares revalidate = 60, which never takes effect
...
### P3-044 src/app/protected/students/[studentId]/page.tsx hardcodes the live session 2026-27
...
### P3-046 src/platform/session/available-sessions.ts hardcodes the live session 2026-27
...
### P3-048 workers/schoolfees-mcp/src/prompts.mjs hardcodes the live session 2026-27
...
### P3-049 workers/schoolfees-mcp/src/toolkit.mjs hardcodes the live session 2026-27
...
### P3-050 workers/schoolfees-mcp/src/tools/orientation.mjs hardcodes the live session 2026-27
...
### P3-051 workers/schoolfees-mcp/worker.mjs hardcodes the live session 2026-27
