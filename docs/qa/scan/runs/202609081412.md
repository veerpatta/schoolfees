...
| Run id | `202609081412` |
| Layers | static |
| Git | `a77d9f613907` on main (dirty) |
| Node | v24.19.0 |
| Files read | 1613 |
| Started | 2026-09-08T14:12:40.238Z |
| Duration | 7194 ms |
| Strict gate | no |
...
10 check(s) swept 15020 of 15020 enumerated members.
...
| `dead-code` | export declarations in app/, components/, lib/, hooks/ and i18n/ | 2466 | 2466 | exhaustive |
