...
| Run id | `202608220554` |
| Layers | static |
| Git | `10f45ccc440a` on main (dirty) |
| Node | v24.19.0 |
| Files read | 1531 |
| Started | 2026-08-22T05:54:07.364Z |
| Duration | 5411 ms |
| Strict gate | no |
...
10 check(s) swept 14502 of 14502 enumerated members.
...
| `i18n` | locale catalogue keys (union x locale) and t() call sites in product source | 7706 | 7706 | exhaustive |
