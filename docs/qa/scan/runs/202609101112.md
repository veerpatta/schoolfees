...
| Run id | `202609101112` |
| Layers | static |
| Git | `c2196bc9f0ae` on main (dirty) |
| Node | v24.19.0 |
| Files read | 1595 |
| Started | 2026-09-10T11:12:17.673Z |
| Duration | 21249 ms |
| Strict gate | no |
...
10 check(s) swept 15044 of 15044 enumerated members.
...
| `dead-code` | export declarations in app/, components/, lib/, hooks/ and i18n/ | 2488 | 2488 | exhaustive |
