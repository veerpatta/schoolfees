...
| Run id | `202609100753` |
| Layers | static |
| Git | `793b569823d2` on main (dirty) |
| Node | v24.19.0 |
| Files read | 1626 |
| Started | 2026-09-10T07:53:05.460Z |
| Duration | 6478 ms |
| Strict gate | no |
...
10 check(s) swept 15058 of 15058 enumerated members.
...
| `sql-safety` | supabase migrations, plus the source files that build SQL text | 1440 | 1440 | exhaustive |
| `i18n` | locale catalogue keys (union x locale) and t() call sites in product source | 7713 | 7713 | exhaustive |
| `dead-code` | export declarations in app/, components/, lib/, hooks/ and i18n/ | 2478 | 2478 | exhaustive |
