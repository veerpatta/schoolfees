# Source scan 202608200244

**PASS** · 117 finding(s) · P0 0 · P1 0 · P2 106 · P3 11
...
| Run id | `202608200244` |
| Layers | static |
| Git | `290ddb3bb874` on main (dirty) |
| Node | v24.19.0 |
| Files read | 1475 |
| Started | 2026-08-20T02:44:40.594Z |
| Duration | 5822 ms |
| Strict gate | no |
...
10 check(s) swept 14317 of 14317 enumerated members.

| Check | Dimension | Domain | Examined | Strategy |
|---|---|---:|---:|---|
| `guards` | app route handlers, pages and server-action modules | 109 | 109 | exhaustive |
| `client-boundary` | source modules crossed against the client bundle import graph | 710 | 710 | exhaustive |
| `session-safety` | product source modules scanned for hardcoded academic-session labels | 710 | 710 | exhaustive |
| `money` | product source files (app, components, lib, workers, hooks, i18n; no tests, no scripts) | 710 | 710 | exhaustive |
| `async-safety` | product .ts/.tsx modules parsed by the TypeScript checker | 678 | 678 | exhaustive |
...
| `dead-code` | export declarations in app/, components/, lib/, hooks/ and i18n/ | 2145 | 2145 | exhaustive |
...
### P2-093 app/protected/students/close-due-actions.ts:47 rounds `value` where the domain core truncates it
...
### P2-094 lib/helpers/amount-in-words-hi.ts:73 rounds `value` where the domain core truncates it
...
### P2-095 lib/helpers/amount-in-words.ts:84 rounds `value` where the domain core truncates it
...
### P2-096 lib/pdf/document-kit.tsx:51 rounds `value` where the domain core truncates it
...
### P2-097 private.enforce_max_active_conventional_discounts is defined without a pinned search_path
...
### P2-098 private.prevent_receipt_adjustment_mutation is defined without a pinned search_path
...
### P2-099 private.enforce_max_active_conventional_discounts_in_schema is defined without a pinned search_path
...
### P2-100 private.enforce_third_child_traceability is defined without a pinned search_path
...
### P2-101 private.derive_family_child_client_request_id is defined without a pinned search_path
...
### P2-102 public.refresh_financial_materialized_views is defined without a pinned search_path
...
### P2-103 private.prevent_notion_sync_log_mutation is defined without a pinned search_path
...
### P2-104 public.v_notion_student_fee_summary does not set security_invoker
...
### P2-105 public.v_notion_daily_collection_summary does not set security_invoker
...
### P2-106 public.v_notion_family_fee_summary does not set security_invoker
...
### P3-107 app/protected/admin-tools/session-health/session-health-grid.tsx hardcodes the live session 2026-27
...
### P3-108 app/protected/exports/page.tsx declares revalidate = 60, which never takes effect
...
### P3-109 app/protected/fee-setup/page.tsx declares revalidate = 60, which never takes effect
...
### P3-110 app/protected/students/[studentId]/page.tsx hardcodes the live session 2026-27
...
### P3-112 lib/session/available-sessions.ts hardcodes the live session 2026-27
...
### P3-114 workers/schoolfees-mcp/src/prompts.mjs hardcodes the live session 2026-27
...
### P3-115 workers/schoolfees-mcp/src/toolkit.mjs hardcodes the live session 2026-27
...
### P3-116 workers/schoolfees-mcp/src/tools/orientation.mjs hardcodes the live session 2026-27
...
### P3-117 workers/schoolfees-mcp/worker.mjs hardcodes the live session 2026-27
