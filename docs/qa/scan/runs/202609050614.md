...
| Run id | `202609050614` |
| Layers | static |
| Git | `ea1be208cfa8` on claude/installment-fee-override-wy98cn (dirty) |
| Node | v22.22.2 |
| Files read | 1561 |
| Started | 2026-09-05T06:14:37.687Z |
| Duration | 8377 ms |
| Strict gate | no |
...
10 check(s) swept 14839 of 14839 enumerated members.

| Check | Dimension | Domain | Examined | Strategy |
|---|---|---:|---:|---|
| `guards` | app route handlers, pages and server-action modules | 120 | 120 | exhaustive |
| `client-boundary` | source modules crossed against the client bundle import graph | 753 | 753 | exhaustive |
| `session-safety` | product source modules scanned for hardcoded academic-session labels | 753 | 753 | exhaustive |
| `money` | product source files (app, components, lib, workers, hooks, i18n; no tests, no scripts) | 753 | 753 | exhaustive |
| `async-safety` | product .ts/.tsx modules parsed by the TypeScript checker | 721 | 721 | exhaustive |
...
| `dead-code` | export declarations in app/, components/, lib/, hooks/ and i18n/ | 2373 | 2373 | exhaustive |
