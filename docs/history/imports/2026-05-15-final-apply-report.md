...
`docs/history/import-previews/2026-05-15-latest-vpps-import/anomalies.csv`.
...
1. **9 in-workbook student duplicates** in `Supabase_Students_Active`
   ...
   Source: `docs/history/import-previews/2026-05-15-latest-vpps-import/anomalies.csv`.
...
| `docs/history/imports/2026-05-15-latest-vpps-data-import.md` | Runbook / design notes |
| `docs/history/imports/2026-05-15-RUN-THIS-TO-FINISH.md` | Mid-flight runbook used in the second turn |
| `docs/history/imports/2026-05-15-final-apply-report.md` | **This file** |
| `docs/history/import-previews/2026-05-15-latest-vpps-import/summary.json` | Dry-run report |
| `docs/history/import-previews/2026-05-15-latest-vpps-import/anomalies.csv` | 9 student duplicates + 27 fee-line duplicates + 1 unknown payment mode |
| `docs/history/import-previews/2026-05-15-latest-vpps-import/student-intents.{json,csv}` | Resolved intent for every workbook row |
| `docs/history/import-previews/2026-05-15-latest-vpps-import/apply-payloads/jsonb/*.json` | The five JSONB payloads shipped to the DB via the edge function |
