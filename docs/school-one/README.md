...
| `decisions.md` | Editable defaults (D-1…D-29). Change here, not in code comments. |
...
| `prompts/phase-0-complete.md` | The end-to-end prompt that executed P0.3 → P0.7 in one session. |
| `phase-0-progress.md` | Phase 0 execution log: what was committed per prompt, the acceptance evidence, and every deviation. |
| `kickoff-report.md` | Output of the kickoff session: environment safety, CLI link, baseline test state, plan corrections. |
...
| `dev-environment.md` | Output of prompt P0.2. Which database is which, the four guards, and why a database is built by restore rather than replay. |
