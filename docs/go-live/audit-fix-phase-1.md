...
Migrations 1.3 (`20260528100000_restore_receipt_idempotency_recheck.sql`) and 1.5 (`20260528100100_waive_late_fee_advisory_lock.sql`) are **not yet applied to production**. Rollout is tracked in `docs/go-live/audit-fix-rollout.md`. The high-level sequence:
