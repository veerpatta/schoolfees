...
| `/protected/collections` | `/protected/payments` | File shim: `app/protected/collections/page.tsx` redirects to the Payment Desk, reconstructing the query string; also listed as a `navigation.ts` alias. |
