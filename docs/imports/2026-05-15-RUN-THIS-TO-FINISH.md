...
`docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/`
...
```text
docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/students/02.sql
docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/students/03.sql
docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/students/04.sql
docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/students/05.sql
docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/students/06.sql
docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/students/07.sql
docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/students/08.sql
docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/students/09.sql
docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/students/10.sql

docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/mapping/01.sql
… through 10.sql

docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/left.sql

docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/payments/01.sql
… through 08.sql

docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/feelines/01.sql
… through 12.sql
```
...
for f in docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/students/*.sql; do
  echo "applying $f"
  psql "$DATABASE_URL" -f "$f"
done
for f in docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/mapping/*.sql; do
  psql "$DATABASE_URL" -f "$f"
done
psql "$DATABASE_URL" -f docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/left.sql
for f in docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/payments/*.sql; do
  psql "$DATABASE_URL" -f "$f"
done
for f in docs/import-previews/2026-05-15-latest-vpps-import/apply-payloads/inline/feelines/*.sql; do
  psql "$DATABASE_URL" -f "$f"
done
```
...
2. **Inspect 9 in-workbook student duplicates** noted in
   `docs/import-previews/2026-05-15-latest-vpps-import/anomalies.csv` (sheet
