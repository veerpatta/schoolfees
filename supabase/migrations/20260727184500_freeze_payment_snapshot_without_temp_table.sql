-- Keep one immutable workbook snapshot for the payment transaction without a
-- session-local temp table. This preserves date-aware allocation semantics and
-- allows plpgsql_check to validate the complete function body.
