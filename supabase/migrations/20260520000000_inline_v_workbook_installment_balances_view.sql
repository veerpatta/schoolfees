-- Inline workbook installment snapshot inside v_workbook_installment_balances view to allow filter pushdown.
...
-- Create v_workbook_installment_balances view with inline SQL logic
