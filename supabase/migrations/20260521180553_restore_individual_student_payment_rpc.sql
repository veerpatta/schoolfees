-- Keep Payment Desk posting strictly student-by-student after removing
-- family pay-together. This restores the RPC signature used by the app and
-- removes the leftover family-payment parameter from the deployed function.
