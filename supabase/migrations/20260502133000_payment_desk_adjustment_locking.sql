-- Serialize quick adjustment mutation + posting allocation for one student.
-- This advisory lock is intentionally acquired before override mutation so quick discounts/waivers
-- and payment allocation cannot race each other for the same student.
...
begin
  ...
  select * from public.post_student_payment(
    p_student_id,p_payment_date,p_payment_mode,p_total_amount,p_reference_number,p_remarks,p_received_by,p_receipt_prefix,p_client_request_id
  );
end;
$$;
