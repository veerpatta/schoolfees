-- Remove mandatory reference number requirement for UPI, bank transfer, and cheque payments.
-- Reference number is optional — staff often process UPI/bank payments without a UTR at hand.
