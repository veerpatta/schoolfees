...
-- 2026-04-24 workbook Students_Master parity refresh.
-- Final schema snapshot definitions synced from 20260424203000_workbook_student_master_projection.sql.
...
-- students by academic year. Posted payments and receipts remain append-only;
-- revised dues are reflected through ledger regeneration and financial state.
