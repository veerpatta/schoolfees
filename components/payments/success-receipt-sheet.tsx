          ...
          {whatsappHref ? (
            <>
              <a
                ...
                className="flex items-center justify-center gap-2 rounded-xl border border-border bg-[#25D366]/10 px-4 py-3 text-sm font-semibold text-[#128C7E] hover:bg-[#25D366]/20 transition-colors"
              >
