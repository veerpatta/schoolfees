...
export async function DashboardShell({
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.15),transparent_24%),radial-gradient(circle_at_top_right,rgba(14,165,233,0.16),transparent_22%),linear-gradient(180deg,#f8fbff_0%,#eef5ff_40%,#f8fbff_100%)] text-slate-900">
      <div className="grid min-h-screen lg:grid-cols-[310px_minmax(0,1fr)]">
        <aside className="hidden border-r border-white/60 bg-white/72 backdrop-blur-xl print:hidden lg:block">
          <div className="brand-grid sticky top-0 flex h-screen flex-col gap-6 overflow-hidden px-5 py-5">
            <Link
              href={homeHref}
            ...
            >
              ...
              <div className="mt-4 inline-flex rounded-full border border-sky-100 bg-sky-50/85 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-sky-700">
            ...
            <div className="mt-auto rounded-[30px] border border-sky-100/90 bg-[linear-gradient(180deg,rgba(255,255,255,0.95),rgba(239,246,255,0.92))] p-4 shadow-[0_20px_50px_-30px_rgba(37,99,235,0.35)]">
