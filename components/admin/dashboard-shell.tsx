...
export async function DashboardShell({
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.15),transparent_24%),radial-gradient(circle_at_top_right,rgba(14,165,233,0.16),transparent_22%),linear-gradient(180deg,#f8fbff_0%,#eef5ff_40%,#f8fbff_100%)] text-slate-900 lg:h-screen lg:overflow-hidden">
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-[250px] border-r border-white/60 bg-white/74 backdrop-blur-xl print:hidden lg:block">
        <div className="brand-grid flex h-full flex-col gap-3 overflow-y-auto px-3 py-4">
          <Link
            href={homeHref}
            className="glass-panel block rounded-[24px] p-3 transition duration-200 hover:-translate-y-0.5"
          >
            <SchoolBrand variant="sidebar" priority />
            <div className="mt-2 inline-flex rounded-full border border-sky-100 bg-sky-50/85 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-sky-700">
          ...
          <div className="mt-auto rounded-2xl border border-sky-100/90 bg-[linear-gradient(180deg,rgba(255,255,255,0.95),rgba(239,246,255,0.92))] p-3.5 shadow-[0_20px_50px_-30px_rgba(37,99,235,0.35)]">
            ...
            <div className="mt-3 rounded-xl border border-sky-100 bg-white/85 px-2.5 py-2 text-[11px] leading-4 text-slate-600">
