...
/**
 * The consolidated sibling statement as a phone reads it.
 *
 * This is the pre-redesign document, moved here unchanged — including its wide
 * tables. The A4 redesign was scoped to desktop and paper, so the phone
 * rendering is deliberately frozen at what it has always been rather than
 * quietly rewritten; giving it card twins is a separate decision.
 * `tests/ui/statement-mobile-overflow.test.ts` records that exemption.
 */
