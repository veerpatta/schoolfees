          ...
          return (
            ...
            >
              <dl className="grid grid-cols-2 gap-3 text-sm">
                {[
                  [t("sessionHealthCardActiveStudents"), card.health.rawStudentsInActiveSession],
                  [t("sessionHealthCardDuesPrepared"), card.health.workbookFinancialRowCount],
                  [t("sessionHealthCardDuesMissing"), card.health.studentsMissingInstallmentRows],
                  [t("sessionHealthCardClassesMissing"), card.health.classesWithoutFeeSettings],
                ].map(([label, value]) => (
                  <div
                    key={String(label)}
