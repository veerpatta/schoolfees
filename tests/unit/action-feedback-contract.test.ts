...
const B_ALLOWED: Record<string, string> = {
  ...
  "src/components/imports/batch-upload-card.tsx": "redirects to ?notice=/?error=, rendered by the imports workflow",
  "src/components/imports/column-mapping-card.tsx": "redirects to ?notice=/?error=",
  "src/components/imports/duplicate-audit-panel.tsx": "redirects to ?notice=/?error=",
  "src/components/imports/import-commit-card.tsx": "redirects to ?notice=/?error=",
  "src/components/imports/row-detail-card.tsx": "redirects to ?notice=/?error=",
