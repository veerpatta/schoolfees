...
describe("payment desk cashier workflow", () => {
  ...
  it("selected student banner has an accessible change button that clears the student", () => {
    ...
    const sheet = readFileSync(
      join(process.cwd(), "src/components/payments/mobile-payment-flow-sheet.tsx"),
      "utf8",
    );
  ...
  it("payment feedback includes toast, distinct haptics, and improved skeleton markers", () => {
    ...
    const confirmSheet = readFileSync(
      join(process.cwd(), "src/components/payments/confirm-receipt-sheet.tsx"),
      "utf8",
    );
  ...
  it("payment desk split keeps the required cashier dialogs and locked states", () => {
    const wrapper = readFileSync(
      join(process.cwd(), "src/components/payments/payment-entry-client.tsx"),
      "utf8",
    );
    ...
    const desktop = readFileSync(
      join(process.cwd(), "src/components/payments/payment-desk-desktop.tsx"),
      "utf8",
    );
    const duplicate = readFileSync(
      join(process.cwd(), "src/components/payments/duplicate-receipt-sheet.tsx"),
      "utf8",
    );
    const success = readFileSync(
      join(process.cwd(), "src/components/payments/success-receipt-sheet.tsx"),
      "utf8",
    );
  ...
  it("payee summary strip component contains sticky header and risk pills", () => {
    const component = readFileSync(
      join(process.cwd(), "src/components/payments/payee-summary-strip.tsx"),
      "utf8",
    );
  ...
  it("records selected-student timing marks and persists successful summaries", () => {
    ...
    const metrics = readFileSync(
      join(process.cwd(), "src/components/payments/payment-desk-metrics.ts"),
      "utf8",
    );
