...
describe("phone student profile", () => {
  const profile = read("src/components/students/mobile-student-profile.tsx");
  ...
  it("clears only the safe area, because the tab bar is gone on a takeover route", () => {
    ...
    expect(readCode("src/components/students/mobile-student-profile.tsx")).not.toContain(
...
describe("phone family tab", () => {
  const family = read("src/components/students/mobile-student-family-tab.tsx");
