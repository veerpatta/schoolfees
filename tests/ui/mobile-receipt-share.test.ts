...
describe("receipt detail on a phone", () => {
  ...
  const bar = read("src/components/receipts/mobile-receipt-action-bar.tsx");
...
describe("receipt preview sheet on a phone", () => {
  const sheet = read("src/components/receipts/receipt-preview-sheet.tsx");
...
describe("payment success screen", () => {
  const sheet = read("src/components/payments/success-receipt-sheet.tsx");
