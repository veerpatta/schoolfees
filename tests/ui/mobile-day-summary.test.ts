...
describe("mobile transactions day summary", () => {
  const component = readRepoFile("src/modules/transactions/ui/mobile-day-summary.tsx");
  const shell = readRepoFile("src/modules/transactions/ui/transactions-client-shell.tsx");
